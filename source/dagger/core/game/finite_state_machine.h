...
public:
	...
	public:
		...
		State(FSM<States>* parent_) : m_Parent {parent_} { }
...
#define DEFINE_STATE(Machine_, States_, State_)                  \
	struct State_ : public State                                 \
	{                                                            \
...
#define DEFAULT_ENTER(Machine_, State_) \
	void Machine_::State_::Enter(Machine_::StateComponent&) { }
#define DEFAULT_EXIT(Machine_, State_) \
	void Machine_::State_::Exit(Machine_::StateComponent&) { }
#define DEFAULT_RUN(Machine_, State_) \
	void Machine_::State_::Run(Machine_::StateComponent&) { }
